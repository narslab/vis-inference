...
RAW_IMAGE_DIR = '../../data/rp/raw/Pictures for AI'
RAW_IMAGE_DIR_SUMMER = '../../data/rp/raw/Summer 2021 AI Photos'
RAW_IMAGE_DIR_FALL = '../../data/rp/raw/Likelihood of Failure Images/'
RAW_IMAGE_DIR_APRIL22 = '../../data/rp/raw/More AI Tree Pics 04_22/'
TIDY_IMAGE_DIR = '../../data/rp/tidy/labeled-images/'
INDEX_DIR = '../../results/rp/index/'
...
def saveImageFiles(image_file_list):
    ...
    read_file = pd.read_excel("../../data/rp/raw/More AI Tree Pics 04_22/Likelihood of Failure Ratings.xlsx")
