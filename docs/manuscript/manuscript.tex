...
\begin{figure}[ht]
  ...
  \begin{subfigure}[t]{.32\linewidth}\centering
    ...
    \caption{Improbable}
  \end{subfigure}
  \caption{Examples of training images in each of the three tree risk categories considered in this study: Probable, Possible and Improbable. Two are shown in each case.}
