...
\begin{figure}[ht]
  ...
  \begin{subfigure}[t]{.32\linewidth}\centering
    \includegraphics[width=\textwidth,keepaspectratio=true]{probable-example-1} %probable_standing dead.JPG

    \includegraphics[width=\textwidth,keepaspectratio=true]{probable-example-2} %Probable (deadwood above line hieght, vine)
    \caption{Probable}
  \end{subfigure}
    \begin{subfigure}[t]{.32\linewidth}\centering
    \includegraphics[width=\textwidth,keepaspectratio=true]{possible-example-1} % Possible (spruce, codominant and dieback)

    \includegraphics[width=\textwidth,keepaspectratio=true]{possible-example-2} % Possible (silver maple, codom weak attach, reaction wood)
    \caption{Possible}   
  \end{subfigure}
  \begin{subfigure}[t]{.32\linewidth}\centering
    \includegraphics[width=\textwidth,keepaspectratio=true]{improbable-example-1} %Improbable_3_london plane
