...
\begin{table}[h!]\small
    ...
    \bf Scenario & \bf Hyperparameter & \multicolumn{4}{c}{\bf Resolution ($n\times n$ pixels)} \\
    &         & 64 & 128 & 224 & 384 \\\midrule
    \multirow{8}{*}{\texttt{Pr\_Po\_Im}} 
        & $ks$    & 7 &  &  &   \\
        & $u_1$   & 128 &  &  &   \\
        & $d_1$   & 0.25 &  &  &   \\
        & $a_1$   & ReLu  &  &  &   \\
